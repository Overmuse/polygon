use crate::domain::aggregates::websocket::Aggregate;
use crate::domain::quotes::websocket::*;
use crate::domain::trades::websocket::Trade;
...
mod tests {
    use super::*;
    use crate::domain::quotes::QuoteCondition;
    use crate::domain::trades::TradeCondition;
